                ...
                <form method="POST" action="{{ route('anggota.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="gelar_depan" name="gelar_depan" 
                               value="{{ old('gelar_depan') }}" placeholder="Dr., Prof., dll (opsional)">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="gelar_belakang" name="gelar_belakang" 
                               value="{{ old('gelar_belakang') }}" placeholder="S.H., M.Si., dll (opsional)">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('jumlah_anak') is-invalid @enderror" 
                               id="jumlah_anak" name="jumlah_anak" value="{{ old('jumlah_anak', 0) }}" 
                               min="0" required>
                        @error('jumlah_anak')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
